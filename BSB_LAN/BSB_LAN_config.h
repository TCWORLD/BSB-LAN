...
*/
const char ntp_server[20] = "uk.pool.ntp.org"; // Set to empty string in case you don't want to use NTP
const char local_timezone[30] = "GMT0BST,M3.5.0/1,M10.5.0";
...
// Setting bus pins
byte bus_pins[2] = {36,4}; //First value - RX pin, second value - TX pin
...
char mqtt_broker_addr[33] = "homeassistant.local:1883"; // MQTT broker. Adjust LoggingMode to activate. Can be IP address or hostname. Optional port can be specified after trailing colon. If omitted, port defaults to 1883.
...
byte mqtt_unit_set = CF_MQTT_UNIT_HOMEASSISTANT; // Units: CF_MQTT_UNIT_LOCALIZED, CF_MQTT_UNIT_HOMEASSISTANT, CF_MQTT_UNIT_NONE
...
byte LoggingMode = CF_LOGMODE_MQTT; //CF_LOGMODE_SD_CARD | CF_LOGMODE_24AVG | CF_LOGMODE_MQTT | CF_LOGMODE_MQTT_ONLY_LOG_PARAMS | CF_LOGMODE_UDP
